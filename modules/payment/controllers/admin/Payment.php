...
use modules\payment\controllers\PaymentFactory;
...
class payment extends Engine
{
    ...
    const ADAPTERS_PATH = 'modules\payment\adapters\\';

    public function __construct()
    {
        parent::__construct();

        $this->payment = new \modules\payment\models\admin\Payment();
    ...
    public function process($id= null)
    {
        ...
        if(empty($i)){
            ...
            if(! $s){
                echo $this->payment->getErrorMessage();
            }
    ...
    {
        $this->response->body(  $this->payment->delete($id) );
    }

    public function pub($id)
    {
        $this->response->body( $this->payment->pub($id));
    }

    public function hide($id)
    {
        $this->response->body(  $this->payment->hide($id));
    }
}