...
class Images extends Backend
{
    ...
    {
        $this->assignToNav(t('images.imagesSizes.action_index'), 'module/run/images/imagesSizes', 'fa-users', 'tools', 10);

        $this->template->assignScript("modules/images/js/admin/images.js");

        //Module events
        events()->add('images.index', [$this, 'index']);
        events()->add('images.upload', [$this, 'upload']);
        events()->add('images.delete', [$this, 'delete']);
        events()->add('trash.remove', [$this, 'remove']);
    }

    /**
     * Images module upload template
     * @param null $content
     * @return string
     */
    public function index($content = null)
    {
        ...
        return $this->template->fetch('modules/images/upload');
    }
    ...
    {
        events()->call('images.upload', ['content_id' => $id]);
    }
