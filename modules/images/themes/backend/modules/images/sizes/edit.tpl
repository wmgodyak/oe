<form action="./module/run/images/imagesSizes/process/{$data.id}" method="post" id="form" class="form-horizontal">
    <div class="form-group">
        <label for="data_size" class="col-sm-3 control-label">{$t.images.imagesSizes.size}</label>
        <div class="col-sm-9">
    ...
    <div class="form-group">
        <label for="data_width" class="col-sm-3 control-label">{$t.images.imagesSizes.width}</label>
        <div class="col-sm-9">
    ...
    <div class="form-group">
        <label for="data_height" class="col-sm-3 control-label">{$t.images.imagesSizes.height}</label>
        <div class="col-sm-9">
    ...
    <div class="form-group">
        <label for="data_quality" class="col-sm-3 control-label">{$t.images.imagesSizes.quality}</label>
        <div class="col-sm-9">
    ...
    <div class="form-group">
        <label for="types" class="col-sm-3 control-label">{$t.images.imagesSizes.types}</label>
        <div class="col-sm-9">
        ...
        <div class="col-md-9 col-md-offset-3">
            <div class="checkbox">
                <label>
                    ...
                    {$t.images.imagesSizes.watermark}
                </label>
            </div>
        </div>
    </div>
    <div class="watermark-settings" style="display: {if isset($data.watermark) && $data.watermark==1}block{else}none{/if} ">
        {* <div class="form-group">
            <label for="data_opacity" class="col-sm-3 control-label">{$t.images.imagesSizes.watermark_opacity}</label>
            <div class="col-sm-9">
        ...
        <div class="form-group">
            <label for="data_position" class="col-sm-3 control-label">{$t.images.imagesSizes.watermark_position}</label>
            <div class="col-sm-9">
                <select name="data[watermark_position]" id="data_position"  class="form-control">
                    <option value="0" {if isset($data.watermark_position) && $data.watermark_position == 0}selected{/if}>{$t.images.imagesSizes.watermark_position_tl}</option>
                    <option value="1" {if isset($data.watermark_position) && $data.watermark_position == 1}selected{/if}>{$t.images.imagesSizes.watermark_position_tr}</option>
                    <option value="2" {if isset($data.watermark_position) && $data.watermark_position == 2}selected{/if}>{$t.images.imagesSizes.watermark_position_br}</option>
                    <option value="3" {if isset($data.watermark_position) && $data.watermark_position == 3}selected{/if}>{$t.images.imagesSizes.watermark_position_bl}</option>
                    <option value="4" {if isset($data.watermark_position) && $data.watermark_position == 4}selected{/if}>{$t.images.imagesSizes.watermark_position_c}</option>
                </select>
            </div>
        </div>
    </div>
