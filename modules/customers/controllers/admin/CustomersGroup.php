...
class CustomersGroup extends Engine
{
    ...
    public function __construct()
    {
        ...
        $this->groups = new \modules\customers\models\CustomersGroup();
    }
    ...
    public function create($parent_id=0)
    {
        ...
        $this->response->body($this->template->fetch('customers/groups/form'));
    }
    ...
    public function tree()
    {
        ...
        foreach ($this->groups->getItems($parent_id, 0) as $item) {
            ...
            $item['a_attr'] = array('id'=> $item['id'], 'href' => 'module/run/customers/index/' . $item['id']);
