<div class="row">
    ...
    <fieldset>
    <legend>{$t.banners_places[$action]}</legend>
    <form action="module/run/banners/places/process/{if isset($data.id)}{$data.id}{/if}" method="post" id="placeForm" class="form-horizontal">
        ...
        <div class="form-group">
            ...
            <div class="col-sm-9">
                <input name="data[width]" id="data_width"  class="form-control" value="{if isset($data.width)}{$data.width}{/if}" required onchange="this.value=parseInt(this.value); if(this.value == 0) this.value = '';">
            </div>
        </div>
        <div class="form-group">
            <label for="data_height" class="col-sm-3 control-label">{$t.banners_places.height}</label>
            <div class="col-sm-9">
                <input name="data[height]" id="data_height"  class="form-control" value="{if isset($data.height)}{$data.height}{/if}" required onchange="this.value=parseInt(this.value); if(this.value == 0) this.value = '';">
            </div>
        </div>
        <div class="form-group">
            <div class="col-sm-9">
