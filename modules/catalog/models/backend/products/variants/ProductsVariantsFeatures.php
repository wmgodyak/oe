 ...
 */
class ProductsVariantsFeatures extends \modules\catalog\models\products\variants\ProductsVariantsFeatures
{
    /**
     * @param $variants_id
     * @param $features_id
        ...
        return self::$db
            ->select("
              ...
              from __products_variants_features v
               join __features_info fi on fi.features_id=v.features_id and fi.languages_id={$this->languages->id}
               join __features_info vi on vi.features_id=v.values_id and vi.languages_id={$this->languages->id}
