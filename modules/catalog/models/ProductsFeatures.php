 ...
 */
class ProductsFeatures  extends \system\models\Features
{
//    /**
//     * @param $categories_id
//     * @param $products_id
...
//                            join __features_info fi on fi.features_id = cf.values_id and fi.languages_id = {$this->languages->id}
...
//                case 'text':
//                case 'textarea':
//                    $features[$k]['value'] = $this->getTextValues($feature['id'], $products_id, $this->languages->id);
//                    break;
//                case 'file':
//                case 'number':
