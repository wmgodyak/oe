 ...
 */
class ProductsCategories extends Plugin
{
    private $categories;
    ...
    {
        return $this->template->fetch('plugins/shop/categories');
    }
    ...
    public function tree()
    {
        ...
        foreach ($this->categories->getItems($parent_id) as $item) {
            ...
            $href = $a == 'productsCategories' ? './content/productsCategories/edit/' . $item['id'] : './content/products/index/' . $item['id'];

            $item['a_attr'] = ['id'=> $item['id'], 'href' => $href];
            $item['li_attr'] = [
                'id'=> 'li_'.$item['id'],
    ...
    public function createCategories($parent_id=0)
    {
        ...
        return $this->template->fetch('plugins/shop/createCategories');
    }
