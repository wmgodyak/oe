...
<div class="contact_form">
    <form id="feedback" method="post" class="contact_form" action="route/feedback/process">
        <div class="form-group">
            <input id="fb_data_name" name="data[name]" required type="text" placeholder="{$t.feedback.name}">
        </div>
        <div class="form-group">
            <input id="fb_data_email" name="data[email]" required type="email" placeholder="{$t.feedback.email}">
        </div>
        <div class="form-group">
            <input id="fb_data_phone" name="data[phone]" placeholder="{$t.feedback.phone}" >
        </div>
        <div class="form-group">
            <textarea name="data[message]" id="fb_data_message" cols="20" rows="5" placeholder="{$t.feedback.message}"></textarea>
        </div>
        <input type="hidden" name="token" value="{$token}">
        <button type="submit" class="btn active_btn">Send</button>
    </form>
</div>
