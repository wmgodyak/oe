            ...
            <div class="container">
                <nav class="nav-bar">
                    ...
                    <div id="header-navbar" class="nav-collapse">
                        <ul class="nav-menu">
                            <li class="active">
                                <a href="https://friday-theme.firebaseapp.com/index-2.html">Home</a>
                            </li>
                        ...
                        <div class="col-xs-12 col-md-4 col-lg-3">
                            <aside>
                                <ul class="nav-coupon-category panel">
                                    <li><a href="index.html#"><i class="fa fa-cutlery"></i>Food &amp; Drink<span>40</span></a>
                                    </li>
                                    <li><a href="index.html#"><i class="fa fa-calendar"></i>Events<span>42</span></a>
                                    </li>
                                    <li><a href="index.html#"><i class="fa fa-female"></i>Beauty<span>48</span></a>
                                    </li>
                                    <li><a href="index.html#"><i class="fa fa-bolt"></i>Fitness<span>33</span></a>
                                    </li>
                                    <li><a href="index.html#"><i class="fa fa-image"></i>Furniture<span>50</span></a>
                                    </li>
                                    <li><a href="index.html#"><i class="fa fa-umbrella"></i>Fashion<span>33</span></a>
                                    </li>
                                    <li><a href="index.html#"><i class="fa fa-shopping-cart"></i>Shopping<span>37</span></a>
                                    </li>
                                    <li><a href="index.html#"><i class="fa fa-home"></i>Home &amp; Graden<span>30</span></a>
                                    </li>
                                    <li><a href="index.html#"><i class="fa fa-plane"></i>Travel<span>48</span></a>
                                    </li>
                                    <li class="all-cat">
                                        <a class="font-14" href="index.html#">All Categories</a>
                                    </li>
                                </ul>
                            </aside>
                        </div>
			                        ...
			                        <i class="fa fa-heart"></i>
                                            ...
                                            <li class="share-btn">
                                                <div class="share-tooltip fade">
                                                    <a target="_blank" href="index.html#"><i class="fa fa-facebook"></i></a>
                                                    <a target="_blank" href="index.html#"><i class="fa fa-twitter"></i></a>
                                                    <a target="_blank" href="index.html#"><i class="fa fa-google-plus"></i></a>
                                                    <a target="_blank" href="index.html#"><i class="fa fa-pinterest"></i></a>
                                                </div>
                                    ...
                                    <div class="col-xs-12">
                                        <div class="panel-body">
                                            ...
                                            <h5 class="deal-title mb-10">
                                                <a href="index.html#">10% off select XPS & Alienware laptops</a>
                                            </h5>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-xs-12">
                                        <div class="panel-body">
                                            ...
                                            <h5 class="deal-title mb-10">
                                                <a href="index.html#">15% off 2 select Amazon Fire cases</a>
                                            </h5>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-xs-12">
                                        <div class="panel-body">
                                            ...
                                            <h5 class="deal-title mb-10">
                                                <a href="index.html#">Flat 40% off hotel bookings in 10 cities</a>
                                            </h5>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-xs-12">
                                        <div class="panel-body">
                                            ...
                                            <h5 class="deal-title mb-10">
                                                <a href="index.html#">There is no place like home 25% off</a>
                                            </h5>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-xs-12">
                                        <div class="panel-body">
                                            ...
                                            <h4 class="color-green mb-10 t-uppercase">10% OFF</h4>
                                            <h5 class="deal-title mb-10">
                                                <a href="index.html#">10% off $399+ refurbished laptops</a>
                                            </h5>
                            ...
                            <div class="footer-top-twitter">
                                ...
                                <ul class="twitter-list">
                                    <li class="single-twitter">
                                        <p class="color-light"><i class="ico fa fa-twitter"></i><a href="index.html#">@masum_rana :</a> Duis aute irure dolor in reprehenderit in voluptate velit esse cillum dolore in reprehenderit.</p>
                                    </li>
                                    <li class="single-twitter">
                                        <p class="color-light"><i class="ico fa fa-twitter"></i><a href="index.html#">@masum_rana :</a> Lorem ipsum dolor sit amet, consectetur adipisicing elit. Ratione id corrupti iusto cupiditate omnis.</p>
                                    </li>
                                </ul>
                            </div>
                        </div>
                        ...
                        <div class="footer-col col-sm-6">
                            <div class="footer-links">
                                ...
                                <ul>
                                    ...
                                    <li><a href="https://friday-theme.firebaseapp.com/404.html">Error 404</a>
                                    </li>
