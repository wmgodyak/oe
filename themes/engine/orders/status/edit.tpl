<form action="./module/run/order/status/process/{$data.id}" method="post" id="form" class="form-horizontal">
    {foreach $languages as $lang}
        <div class="form-group">
            <label for="info_{$lang.id}" class="col-sm-3 control-label">{$t.order.status.status} ({$lang.code})</label>
            <div class="col-sm-9">
    ...
    <div class="form-group">
        <label for="data_bg_color" class="col-sm-3 control-label">{$t.order.status.bg_color}</label>
        <div class="col-sm-9">
    ...
    <div class="form-group">
        <label for="data_txt_color" class="col-sm-3 control-label">{$t.order.status.txt_color}</label>
        <div class="col-sm-9">
    ...
    <div class="form-group">
        <label for="data_external_id" class="col-sm-3 control-label">{$t.order.status.external_id}</label>
        <div class="col-sm-9">
    ...
    <div class="form-group">
        <label for="data_on_site" class="col-sm-3 control-label">{$t.order.status.on_site}</label>
        <div class="col-sm-9">
    ...
    <div class="form-group">
        <label for="data_is_main" class="col-sm-3 control-label">{$t.order.status.is_main}</label>
        <div class="col-sm-9">
