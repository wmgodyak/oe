<fieldset>
    ...
    {foreach $languages as $i=>$lang}
        <div class="form-group lang-{$lang.code} switch-lang" {if $i>0}style="display:none"{/if}>
            <label for="info_{$lang.id}_h1" class="col-md-3 control-label">{$t.content.h1}</label>
            <div class="col-md-9">
        ...
        <div class="form-group lang-{$lang.code} switch-lang" {if $i>0}style="display:none"{/if}>
            <label for="info_{$lang.id}_title" class="col-md-3 control-label">{$t.content.title}</label>
            <div class="col-md-9">
        ...
        <div class="form-group lang-{$lang.code} switch-lang" {if $i>0}style="display:none"{/if}>
            <label for="info_{$lang.id}_description" class="col-md-3 control-label">{$t.content.description}</label>
            <div class="col-md-9">
