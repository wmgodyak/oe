<form action="module/run/delivery/process/{if isset($data.id)}{$data.id}{/if}" method="post" id="form" class="form-horizontal">
    ...
    <div class="form-group">
        ...
        <div class="col-sm-9">
            <input name="data[price]" id="data_price"  class="form-control" value="{if isset($data.price)}{$data.price}{/if}">
        </div>
    </div>
    ...
    <div class="form-group">
        ...
        <div class="col-sm-9">
            <input name="data[free_from]" id="data_free_from"  class="form-control" value="{if isset($data.free_from)}{$data.free_from}{/if}">
        </div>
    </div>
    ...
    <div class="form-group">
        <label for="data_module" class="col-sm-3 control-label">{$t.delivery.module}</label>
        <div class="col-sm-9">
        ...
        <div class="col-md-10 col-md-offset-2">
            <div class="checkbox">
                <label>
                    ...
                    <input type="checkbox" {if isset($data.published) && $data.published}checked{/if} name="data[published]" id="data_published" value="1" > {$t.delivery.published}
                </label>
            </div>
        </div>
    </div>
