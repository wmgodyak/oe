<form action="./components/process/{$data.id}" method="post" id="form" class="form-horizontal">
    <div class="form-group">
        ...
        <div class="col-sm-9">
            <select class="form-control" name="data[parent_id]" id="data_parent_id">
                <option value="0" selected>{$t.components.install_label_tree_home}</option>
    ...
    <div class="form-group">
        <label for="icon" class="col-sm-3 control-label">{$t.components.icon}</label>
        <div class="col-sm-9">
            <input name="data[icon]" id="icon"  class="form-control" value="{$data.icon}" required>
        </div>
    </div>
    <div class="form-group">
        <label for="position" class="col-sm-3 control-label">{$t.components.position}</label>
        <div class="col-sm-9">
    ...
    <div class="form-group">
        <label for="rang" class="col-sm-3 control-label">{$t.components.rang}</label>
        <div class="col-sm-9">
            <input name="data[rang]" id="rang"  class="form-control" value="{$data.rang}" required>
        </div>
    </div>
    <input type="hidden" name="token" value="{$token}">
    <input type="hidden" name="c" value="{$components}">
</form>