...
INSERT INTO `__settings` (`id`, `name`, `value`, `block`, `type`, `required`, `display`) VALUES
  ...
  (8, 'languages_create_info', '0', 'common', 'text', 1, 1),
  (9, 'app_theme_current', 'default', 'themes', 'text', 1, 1),
  (10, 'app_views_path', 'views/', 'themes', 'text', 1, 1),
  (11, 'app_chunks_path', 'chunks/', 'themes', 'text', 1, 1),
  ...
  (23, 'content_images_quality', '70', 'images', 'text', 1, 1),
